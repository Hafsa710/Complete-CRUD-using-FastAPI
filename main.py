...
def deletePerson(person_id:int):
    ...
    if find_person is not None:
      ...
      raise HTTPException(status_code=status.HTTP_404_NOT_FOUND,detail="Person Deleted Successfully")
     
    raise HTTPException(status_code=status.HTTP_404_NOT_FOUND,detail="Person with this id is already deleted or not found")
